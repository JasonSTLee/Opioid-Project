...
-- SCATTER PLOT FROM total_dosage_per_pop
-- MAP GRAPH FROM TOTAL DOSAGES PER ZIP / COUNTY; COUNTY FIRST THEN ZIP IF COUNTY DOESNT WORK
-- STACK HORIZ BAR GRAPH WITH DOSAGE PER ERA PER STATE
-- VERTICAL BAR CHART SHOWING THE YOY PILL RATE TOP 10
-- STACKED LINE GRAPH OF YEAR OVER YEAR DEATH and TOTAL PILLS 